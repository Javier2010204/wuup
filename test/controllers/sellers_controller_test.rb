...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { address: @seller.address, email: @seller.email, name: @seller.name, phone: @seller.phone, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { address: @seller.address, email: @seller.email, name: @seller.name, phone: @seller.phone, user_id: @seller.user_id } }
